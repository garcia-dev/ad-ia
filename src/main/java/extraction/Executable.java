...
public class Executable {
	...
	private static final List<Variable> BOOLEAN_VARIABLE_LIST
			= new ArrayList<>(List.of(LEFT_COLOR_BLACK, LEFT_COLOR_RED,
									  LEFT_COLOR_WHITE, ROOF_COLOR_BLACK,
									  ROOF_COLOR_RED, ROOF_COLOR_WHITE,
									  OPENING_ROOF_0, OPENING_ROOF_1,
									  HOOD_COLOR_BLACK, HOOD_COLOR_RED,
									  HOOD_COLOR_WHITE, SONO_0, SONO_1,
									  TAILGATE_COLOR_BLACK, TAILGATE_COLOR_RED,
									  TAILGATE_COLOR_WHITE, RIGHT_COLOR_BLACK,
									  RIGHT_COLOR_RED, RIGHT_COLOR_WHITE));
	...
	public static void main(String[] args) {
		...
		associationRuleMap.forEach(
				(key, value) -> System.out.println(key.get(0) + " -> "
														   + key.get(1)
														   + " - Frequency: "
														   + value.get(0)
														   + " - Trust: "
